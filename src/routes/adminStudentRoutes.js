...
import { index, show, store, update, transfer, transferHistory, destroy } from '../controllers/adminStudentController.js';
...
router.get('/:id/transfer-history', validate(entityIdParamSchema, 'params'), transferHistory);
